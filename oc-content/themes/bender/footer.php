...
<div id="footer">
    <div class="wrapper">
        ...
        <?php if( (!defined('MULTISITE') || MULTISITE==0) && osc_get_preference('footer_link', 'bender') !== '0') {
            echo '<div>' . sprintf(__('This website is proudly using the <a title="Osclass Evolution web" href="%s">classifieds scripts</a> software <strong>Osclass Evolution</strong>'), 'https://osclass-evo.com/') . '</div>';
        }
        ?>
